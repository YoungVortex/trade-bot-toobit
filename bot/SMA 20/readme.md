...
| File | Description |
|------|-------------|
| `sma20_analysis_*.png` | All-in-one chart (SMC + Trade Plan + all analysis data) |
| `sma20_report_*.pdf` | Multi-page PDF report |
| `sma20_complete_*.txt` | Full text report |
| `sma20_data_*.json` | JSON data export |
...
| 4 | Trend Analysis | SMA20 slope, trend direction, strength |
...
| # | Module | Description |
|---|--------|-------------|
| 21 | Backtesting | SMA20 strategy backtest, win rate, Sharpe |
